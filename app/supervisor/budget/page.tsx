...
import { TrendingUp, TrendingDown, AlertTriangle, PieChart, DollarSign, Eye } from 'lucide-react';

const BUDGET_DATA = [
    { id: '1', dept: 'IT Infrastructure', code: 'CC-102', type: 'CAPEX', allocated: 50000000000, used: 32500000000, committed: 4500000000 },
    { id: '2', dept: 'IT Operations', code: 'CC-103', type: 'OPEX', allocated: 12000000000, used: 8500000000, committed: 150000000 },
    { id: '3', dept: 'General Affairs', code: 'CC-201', type: 'OPEX', allocated: 5000000000, used: 4200000000, committed: 300000000 },
    { id: '4', dept: 'Marketing', code: 'CC-301', type: 'OPEX', allocated: 8000000000, used: 7200000000, committed: 50000000 },
    { id: '5', dept: 'Compliance', code: 'CC-401', type: 'OPEX', allocated: 3000000000, used: 1500000000, committed: 850000000 },
];

export default function SupervisorBudgetPage() {
                        ...
                        {BUDGET_DATA.map((budget) => {
                            ...
                            return (
                                <tr key={budget.id} className="hover:bg-slate-50">
                                    ...
                                    <td className="px-6 py-4">
                                        <Link href={`/supervisor/budget/${budget.id}`} className="text-[#0052CC] hover:text-blue-700">
