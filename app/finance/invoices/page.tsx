    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-[#0B1120] tracking-tight">Invoice Processing</h1>
                    <p className="text-sm text-slate-500 mt-1">Verify and process vendor invoices for payment.</p>
                </div>
